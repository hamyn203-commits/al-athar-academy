...
| المرحلة | العنوان الهندسي | المخرجات البرمجية |
|---|---|---|
| **V7.1** | **معمارية البيانات والربط العائلي** | نموذج `GroupCircle`، نموذج `TrialRequest`، تحديث `User` لدعم ربط ولي الأمر، وتحديث `Session`. |
| **V7.2** | **محرك الحجز ورسائل الواتساب** | حجز التجربة، تنبيهات 24س و 30د، ونظام الاعتذار قبل 6س عبر الواتساب. |
| **V7.3** | **الفصل الافتراضي التفاعلي** | المصحف المتزامن، المايكات والدور، وضع مراقبة ولي الأمر، وفلتر حظر الأرقام. |
| **V7.4** | **بوابة ولي الأمر والتقارير** | إرسال بطاقة التقرير للواتساب، ولوحة متابعة كل الأبناء. |
| **V7.5** | **المسارات وجوائز الأطفال** | المسارات الثلاثة، مكتبة الـ PDF، ونظام مسابقات كل 6 أشهر والجوائز. |
| **V7.6** | **المحرك المالي وأجور المعلمين** | تسعير الـ 20 ج والـ 1$، وحساب مستحقات المعلمين مع InstaPay. |
| **V7.7** | **شات بوت خدمة العملاء** | بوت الموقع للمبيعات والدعم الفني وحجز التجربة. |
